...
topic: Backend
description: See how Jenyus leverages the GraphQL API using their own integration of GraphQL-Utils for the NestJS framework to optimize database queries with a declarative approach.
date: 2021-03-08
tags:
  - name: GraphQL
    color: "#DE33A6"
